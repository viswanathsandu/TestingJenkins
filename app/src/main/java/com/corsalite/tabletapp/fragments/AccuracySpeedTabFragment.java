...
import com.corsalite.tabletapp.adapters.CustomLegendAdapter;
...
public class AccuracySpeedTabFragment extends Fragment   {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        enableRecyclerViewScrollEnbled();
    ...
    private void enableRecyclerViewScrollEnbled(){
        rvChapterLegend.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            @Override
        ...
        rvDatesLegend.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            @Override
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                int action = e.getAction();
                switch (action) {
