...
public class AddExamScheduleDialogFragment extends DialogFragment {
    ...
    @Bind(R.id.et_hall_ticket)
    EditText hallTicketNumber;
    @Bind(R.id.btn_cancel)
    Button cancel;
    @Bind(R.id.btn_submit)
    Button submit;
    @Bind(R.id.ll_add_exam_date)
    LinearLayout addExamDate;
    @Bind(R.id.ll_add_hall_tckt)
    TextInputLayout addHallTicket;
