    ...
    (function() {
        ...
        function v(a, b, e, l) {
            ...
            if (l.doFilter) {
                ...
                if (!a || !a.valid) return e.push(b), 1;h = a.validAttributes;
                var G = a.validStyles;
                r = a.validClasses;
                var u = b.attributes,
                    k = b.styles,
            ...
            n = function() {
                ...
                return function(n, x, H, I) {
                    ...
                    if (!I.checkReadOnly()) {
                        ...
                        I = n.mergeCandidates;
                        var L, v;
                        "text" == n.type && x.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (L = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", x.document), x.insertNode(L), x.setStartAfter(L));
